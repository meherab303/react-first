...
const Blog = ({blog,handleBookmark,handleMarkAsRead}) => {
    const{id,title,post_date,cover,author_img,hashtag,reading_time}=blog
    return (
        <div>
            <img src={cover} alt="" />
         ...
         <div>
         <button onClick={()=>handleMarkAsRead(reading_time,id)} className='text-blue-700 mb-3'>Mark as read</button>
         </div>
